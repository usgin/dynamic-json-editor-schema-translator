...
function visu (error, treeData) {
    ...
    update = function(source) {
        ...
        var newHeight = d3.max(levelWidth) * 200; // line size
        ...
        nodes.forEach(function(d) {
            ...
            if  (d.depth == 1 ) { d.y = 150;  d.x = 0 }

            if  (d.depth == 2 ) { d.y = 250; }
             if  (d.depth > 2 ) {
            ...
            if  (d.depth == 0 ) { d.y = 25;  d.x = -300 } 

            if  (d.depth == 1 ) { 
               
                d.y = 25 + leve1*maxLabelLength*scale; 
                leve1++;
                d.x =-250;
                 } // +  msgLen * scaleFactor; // GHud -- maxLabelLength * 10px
            if  (d.depth == 2 ) {
                 d.y = 25 + leve1*maxLabelLength*scale; 
                 d.x = -280 + 30*lev2; lev2++ }
            if  (d.depth > 2 ) {
                 d.y = 25 + leve1*maxLabelLength*scale; 
                 d.x = -280 + 30*lev2*d.depth; } 
               // d.y = (1 + d.depth) * maxLabelLength*6; } //p8arY + maxLabelLength; }
           //maxLabelLength * scale; }
           */
