    ...
    function click(d) {
        ...
        if ( d.datatype == "subschema" ) {
            ...
            if ( typeof(gCKAN_pid) !== "undefined" &&  gCKAN_pid.length > 1) {
               // showSave(); - hangs it on 2 many clicks
        ...
        tree = tree.size([newHeight, viewerWidth])
         ...
         .separation(function(a, b) { 
                ...
                if (a.parent == b.parent) {
                    if ( (a.children && a.children.length > 1) || (b.children && b.children.length > 1) ) {
                        var mc;

                        ( a.children) ? mc = a.children.length : mc = dist;
                        ( b.children && b.children.length > mc ) ? mc = b.children.length : mc = mc;
                        //( a.children.length > b.children.length) ? mc = a.children.length: mc = b.children.length;
                       dist = mc; 
                    }
                } else {
                     if ( ( a.children && a.children.length > 1) || (b.children && b.children.length > 1 ) ) {
...
*/
        ...
        nodes.forEach(function(d) {
            ...
            /*
             if ( typeof(d.datatype) != "undefined" && d.datatype == "textarea" ) {
                 if ( typeof(d.value) != "undefined" && d.value.length > txtAreaLineSize ) {
                    runningYoffset = ( d.value.length / txtAreaLineSize )* 12;
                 }
             }
             */
        ...
        var nodeEnter = node.enter().append("g") 
            ...
            /*
               // if ( d.depth == 0 ) { console.log (' source name is ' + source.name + ' ' )}
                  console.log(' enter transform ' + d.name + ' ' + d.id + ' ' + d.y + ' dx ' + d.x);
                ...
                //if (d.name == source.name) { return "translate(" + source.y0  + "," + source.x0 + ")"; }
       ...
       // console.log("building the tree node " + source.name);
        ...
        nodeEnter.append("text")
            ...
            .attr("y", 0)
            //.attr("x", function(d) {
             //   return d.children || d._children || ( typeof(d.datatype) != "undefined" && d.datatype == "subschema" ) ? 0 : 10;
           // })
            //.attr("y", function(d) {
                ...
                if ( typeof(d.datatype) != "undefined" && d.datatype != "textarea" ) {
                   ...
                   // ( typeof(d.display) != "undefined" && d.display != "" ) ? dText = d.display: dText = d.name;
                    ...
                    if ( d.children || d._children ) { 
                        rtnVal = "";
                       // ( dValue ) ? rtnVal = dValue : rtnVal = dText; 
                    }
                   // else { ( d.display ) ? rtnVal = dValue : rtnVal = dValue }
        ...
        nt.each(function(d) {
           // .text(function(d) {
                ...
                if ( typeof(d.datatype) != "undefined" && d.datatype == "textarea" ) {
                    if ( typeof(d.value) != "undefined" && d.value.length > 1 ) {
                       if ( d.value.length >= txtAreaLineSize ) {
                            ...
                            //var rtnVal = d.value.substring(0,80) + ' ...';
                           //var rtnVal = wrap(d.value, 80 );
                           //var rtnVal = '<div>' + d.value.substring(10,80) + '</br>' + d.value.substring(80,200) + '</div>';
                        }
                    } 
                } else {
                    rtnVal = d.value;
            ...
            //.attr("x", function(d) {
            //    return d.children || d._children || ( typeof(d.datatype) !== "undefined" && d.datatype=="subschema" ) ? -40 : 10;
            //})
            //.attr("text-anchor", function(d) {
            //    return d.children || d._children || ( typeof(d.datatype) !== "undefined" && d.datatype=="subschema" ) ? "start" : "start";
            //})
            ...
            */
            ...
            .text(function(d) {
                ...
                if ( typeof(d.datatype) != "undefined" && d.datatype != "textarea" ) { 
                    ...
                    if ( d.children || d._children ) { ( dValue ) ? rtnVal = dValue : rtnVal = dText; }
                    else { ( d.display ) ?  rtnVal = d.display + ':' + dValue : rtnVal = dValue }
                    if ( d.datatype == "subschema" ) { rtnVal = d.display }
                    return rtnVal;
                }
            });
           */
