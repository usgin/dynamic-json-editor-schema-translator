    ...
    function click(d) {
       ...
       // if (d3.event.defaultPrevented) return; // click suppressed
        ...
        update(d);
            //centerNode(d);
       // } else {
        //    alert("click position: x - "  +d.x + " Y = " + d.y)
    ...
    update = function(source) {
         ...
         nodeEnter.append("rect")
          ...
          .attr("height", function(d) {
            ...
            if ( typeof(d.datatype) != "undefined" && d.datatype == "textarea" ) {
                 if ( typeof(d.value) != "undefined" && d.value != "" && d.value !== null ) {
                    var lines = Math.round(d.value.length/txtAreaLineSize);
                    txtHeight = txtHeight + lines*txtHeight;
                 }
            }  
            */
             return 25; 
          ...
          .attr("width",  function(d) {
            ...
            if ( typeof(d.datatype) != "undefined" && d.datatype == "textarea" ) {
             ...
             //console.log('text box ' + d.name + " string " + d.value + " size " + textLen );
             return textLen;
          })
          .style("fill", '#ccc');
        ...
        nodeEnter.append("text")
            ...
            nodeEnter.append("div")
                ...
                .text("whatup");
                //.innerHTML(function(d) { return d.value });
                    ...
                    if ( typeof(d.datatype) != "undefined" && d.datatype == "textarea"  ) {
                            if ( typeof(d.value) != "undefined") {
                               if ( d.value.length >= 50 ) {
                                    ...
                                    for (i ==0; i < d.value.length; i = i+ txtAreaLineSize) {
                                        rStr = rStr + d.value.substring(i,i+txtAreaLineSize) + '\n';
                                   }
                                  //rStr = rStr + '</tspan>';
                                  //span.innerHTML = rStr;
                                  ...
                                  /*
                                  for (i ==0; i < d.value.length; i = i+ txtAreaLineSize) {
                                      rStr = rStr + d.value.substring(i,i+txtAreaLineSize) + "<br>";
                                   }
                                   rStr = rStr + "-";
                                   return rStr; 
                               }
